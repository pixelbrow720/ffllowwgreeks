...
//
// `overflow-hidden` on the inner column locks GEX SVG inside its cell —
// otherwise the SVG aspect-ratio bumps the row to ~2400px tall and the
// dashboard turns into a scroll-fest with empty bands.
export default function DashboardPage() {
  const [symbol, setSymbol] = useState<Sym>("SPX");

  return (
    <div className="min-h-[1056px] flex flex-col bg-bg-base text-ink-base">
